...
public class BusinessData extends AsyncTask<Void, Void, Void> {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            URL url = new URL("https://newsapi.org/v2/top-headlines?country=il&category=business&apiKey=ac326d18823d400c86b4a42c46d5a6f9");
